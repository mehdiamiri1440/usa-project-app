module.exports = {
  ...
  strings: {
    ...
    "labels.man": "آقا",
    "labels.watingForAcceptance": "انتظار تایید",
    'labels.putAMessage': 'پیامی بگذارید',
    "labels.noNewProductOr": "محصول جدیدی ثبت نشده یا در ",
    "labels.afterRegisterRequestPressButton": "بعد از ثبت درخواست، منتظر تایید آن توسط کارشناسان باسکول بمانید.",
    "labels.noNewRequestOr": "هیچ درخواست خریدی ثبت نشده یا در",
    ...
    'labels.or': 'یا',
    "labels.pressButtonToRegisterProduct": "برای ثبت محصول جدید در باسکول، از طریق دکمه ثبت محصول اقدام کنید.",
    'labels.yes': 'بله',
    'labels.no': 'خیر',
    'labels.today': 'امروز',
    ...
    "labels.promoteYourAccountToAccessPhoneAndBuyers": "برای دسترسی به خریداران طلایی و شماره های تماس ، حساب کاربری خود را ارتقا دهید.",
    "labels.becomeBuskoolSpecialUser": "کاربر ویژه باسکول شوید!",
    'labels.CouldNotFindSellerYet': 'هنوز خریدار محصول خود را پیدا نکرده اید؟!',
    'labels.registerProductToAccessBuyerListMadeForYou': 'با ثبت محصول به لیست خریداران پیشنهادی مخصوص خود ، دسترسی پیدا کنید.',
    'labels.authentication': 'احراز هویت',
    'labels.sendMessage': 'ارسال پیام',
    'labels.chooseProductCategory': 'انتخاب دسته‌بندی محصول',
    'labels.call': 'تماس',
    'labels.accessToMoreFeaturesOfBuskool': 'دسترسی به امکانات بیشتر بازار باسکول',
    ...
    'labels.accessToBuyersContactInfo': 'دسترسی به شماره تماس خریداران',
    'labels.inquireDelsa': 'استخدام منشی آنلاین (دلسا)',
    'labels.giveBuyersAccessToYourContactInfo': 'نمایش شماره تماس شما به خریداران',
    ...
    'labels.selectYourActivityZone': 'حوزه فعالیت خود را انتخاب کنید',
    'labels.IAmSeller': 'فروشنده ام',
    'labels.IAmBuyer': 'خریدارم',
    ...
    'labels.annualPackageFeatures': 'ویژگی های بسته ویژه',
    ...
    'labels.20%Better': '۲۰٪ بصرفه تر !',
    'labels.annualPackageDescription': 'این بسته شامل مجموعه امکاناتی مانند اعمال نردبان رایگان ، مشاهده بدون تاخیر درخواست های خرید ، دریافت پیامک درخواست های خرید مرتبط و .. است که باعث فروش محصولات شما در رسیع ترین زمان ممکن می شود.',
    ...
    'labels.uploadIdCardLikeSample': 'تصویر کارت ملی خود را طبق نمونه بارگذاری کنید.',
    ...
    "labels.5xConnectionWithBuyers": '۵ برابر ارتباط بیشتر با خریداران',
    ...
    "labels.seeBuyers": 'مشاهده خریداران',
    "labels.seeSellers": 'مشاهده فروشندگان',
    'labels.noCaseFound': 'موردی برای {fieldName} یافت نشد!',
    'labels.noSellerFound': 'فروشنده‌ ای یافت نشد!',
    'labels.noCaseFor': 'موردی برای',
    'labels.nothingFoundFor': 'یافت نشد.',
    'labels.noBuyerFound': 'خریداری یافت نشد!',
    'labels.is': 'هستم',
    'labels.addImage': 'افزودن تصویر',
    'labels.inUse': 'درحال استفاده',
    "labels.noRelatedBuyer": "خریدار مرتبطی ندارید!",
    'labels.registerProductToSeeBuyers': 'برای مشاهده خریداران مرتبط، ابتدا محصول خود را ثبت کنید.',
    ...
    'labels.30%DiscountForNewJoining': '۳۰٪ تخفیف عضویت جدید',
    ...
    'labels.threeMonthPackageDescription': 'این بسته شامل مجموعه امکانات پایه باسکول شامل منشی آنلاین ، نمایش شماره تماس شما به خریداران و دسترسی به خریداران بیشتر است.',
    ...
    'labels.zero': 'صفر',
    'labels.inviteFriendsText': 'با دعوت از همکاران خود به باسکول می‌توانید کسب درآمد کنید. در صورتی که همکار دعوت شده به جمع باسکول بپیوندد بعد از خرید هر کدام از سرویس های غیر رایگان باسکول،',
    'labels.halfOfBuyAmount': 'نصف مبلغ خرید به کیف پول باسکول شما اضافه می شود.',
    'labels.willBeAddedToWallet': 'همین حالا دعوت نامه را ارسال کنید',
    ...
    'labels.registerProductAndFindBuyer': 'ثبت محصول و یافتن خریدار',
    ...
    'labels.seeSellersProductsList': 'مشاهده لیست محصولات فروشندگان',
    'labels.requestsBlurDate': '۱۳ تیر , ۱۳۰۴',
    'labels.sendYourProfileToYourFriends': 'ارسال پروفایل تجاری شما به دوستان',
    'labels.advertiseProductsInBuskoolChannel': 'تبلیغ محصولات شما در کانال باسکول',
    ...
    'labels.noChatFound': 'هیچ پیام جدیدی ندارید !',
    "labels.sendMessageToConnectUsers": "برای شروع گفتگو با خریداران و فروشندگان باسکول، پیام ارسال کنید.",
    ...
    'labels.callWithSeller': 'تماس با فروشنده',
    'labels.wannaSubmitABuyAd': 'می خواهم درخواست خرید ثبت کنم',
    'labels.haveProductToSell': 'محصول برای فروش دارم',
    ...
    'labels.specialPackageDescription': 'این بسته شامل مجموعه امکاناتی مانند اعمال نردبان رایگان ، مشاهده بدون تاخیر درخواست های خرید ، دریافت پیامک درخواست های خرید مرتبط ، نمایش متفاوت و در اولویت بودن در لیست محصولات ، نشان فروشنده ویژه و... است.',
    'labels.elevatorPackageDescription': 'با اعمال هربار نردبان محصول شما در بالای لیست محصولات قرار میگیرد.',
    'labels.passwordPackageDescription': 'درصورتی که قادر به خرید اینترنتی نیستید ، برای پرداخت ازطریق کارت به کارت با ما تماس بگیرید.',
    "labels.one": 'یک',
    ...
    'labels.authFirstHelp': '1- کارت ملی خود را روی کاغذ سفید (A4) بچسبانید.',
    'labels.authSecondHelp': '2- روی کاغذ متن زیر را بنویسید و امضا کنید و سپس با آن مطابق نمونه زیر، عکس بگیرید.',
    'labels.iUploadMyIdCardForBuskool': 'اینجانب ...... کارت ملی خود را جهت احراز هویت در بازار باسکول ارسال می‌نمایم.',
    "labels.product": 'محصول',
    ...
    'labels.authenticaitonSample': 'نمونه گواهی احراز هویت',
    'labels.uploadAuthenticationEvidence': 'بارگذاری گواهی احراز هویت شما',
    'labels.imageOfAuthenticationEvidence': 'تصویر گواهی احراز هویت شما',
    ...
    'titles.minOfThePrice': 'کف قیمت',
    'titles.forEachKilo': 'برای هر کیلو',
    'titles.status': 'وضعیت',
    ...
    'titles.canNotAccessBuyersNumbers': "به شماره تماس خریداران دسترسی ندارید!",
    'titles.updateBuskool': 'بروزرسانی باسکول',
    'titles.no': 'خیر',
    'titles.newVersionUpdate': 'نسخه جدید باسکول رسید!',
    'titles.clickOnButtonToUpdateApp': 'برای بروزرسانی برنامه باسکول و دسترسی به امکانات جدید، روی دکمه بروزرسانی بزنید.',
    ...
    'titles.botSentItAutomatically': 'ارسال شده توسط ربات خودکار دلسا',
    'titles.registeredProductsCount': 'تعداد محصولات ثبت شده',
    "titles.password": 'کلمه عبور',
    'titles.instagramStory': 'استوری اینستاگرام',
    'titles.telegram': 'تلگرام',
    'titles.gotIt': 'متوجه شدم',
    'titles.sendPhonePrice': 'هزینه ارسال شماره به هر خریدار 500 تومان می‌باشد.',
    ...
    'titles.price': 'قیمت',
    'titles.seeBuyAdsRequests': 'مشاهده درخواست های خرید',
    'titles.hello': 'سلام',
    'titles.imDelsa': 'من دلسا هستم',
    'titles.BuskoolBot': 'ربات خودکار باسکول',
    'titles.buyAdRequests': 'درخواست های خرید',
    ...
    "titles.login": 'ورود',
    'titles.welcomeToBuskool': 'به باسکول خوش آمدید',
    'titles.BuskoolWebSiteAndApplication': 'وبسایت و اپلیکیشن باسکول',
    'titles.clickExtraCapacityButton': 'برای ثبت محصولات بیشتر، ظرفیت ثبت محصول  حساب خود را افزایش دهید.',
    'titles.maximumProductRegisteration': 'امکان ثبت محصول جدید را ندارید!',
    ...
    'titles.doesNotHaveSecondPasswordToPayOnLine': 'رمز دوم برای خرید آنلاین ندارم !',
    'titles.whatIsElevatorInSpecialPaymentPackage': 'نردبان در بسته ی ویژه فروش چیست ؟',
    ...
    'titles.pleasePromoteYourUserAccountToSeeBuyersMobiles': 'برای مشاهده شماره تماس های خریداران، لطفا نوع عضویت خود را ارتقا دهید.',
    ...
    'titles.requestSubmittedSuccessfully': 'درخواست خرید شما با موفقیت ثبت شد!',
    'titles.registerRequestFullDescription': 'درخواست خرید شما ، پس از تایید کارشناسان باسکول ، به فروشندگان نمایش داده می شود.',
    ...
    'titles.youDoNotHaveAccessToSpecialBuyersInBuskool': 'شما به خریداران طلایی دسترسی ندارید!',
    'titles.toAccessGoldenRequestsPleasePromoteYourAccount': 'برای دسترسی به درخواست های خرید طلایی، نوع عضویت خود را ارتقا دهید.',
    ...
    "titles.youHaveReachedMaxSendingMessageLimitation": 'سقف روزانه ارسال پیام به خریداران پر شد!',
    'titles.IncreaseYourCapacityToSendMoreMessagesToBuyers': 'برای ارسال پیام به خریداران بیشتر، ظرفیت پاسخگویی روزانه خود را افزایش دهید.',
    ...
    'titles.yourProvince': 'استان شما',
    'titles.yourCity': 'شهر شما',
    'titles.letsStart': 'شروع کنید',
    ...
    'titles.productdAccepted': 'محصول شما ، پس از تایید کارشناسان باسکول ، در لیست محصولات قرار خواهد گرفت .',
    ...
    'titles.idCardSample': 'نمونه تصویر کارت ملی',
    ...
    'titles.yourNationalCardImage': 'تصویر کارت ملی شما',
    'titles.uploadIdCardSample': 'بارگذاری تصویر کارت ملی شما',
    ...
    'titles.buyersAndSellersAccess': 'دسترسی به هزاران خریدار و بازرگان عمده در بزرگترین عمده فروشی کشور .',
    'titles.specialSellersTo': 'فروشندگان ویژه به',
    'titles.moreRealBuyers': 'خریداران واقعی بیشتری',
    'titles.haveAccessTo': 'دسترسی دارند',
    ...
    'titles.specialPackageFirstDescription': 'این بسته شامل مجموعه امکاناتی مانند اعمال نردبان رایگان، مشاهده بدون تاخیر درخواست های خرید، دریافت پیامک درخواست های خرید مرتبط و … است که',
    "titles.specialPackageDescription": 'با این بسته می توانید از تمام امکانات ارتباطی باسکول حداکثر استفاده را داشته باشید. بدون محدودیت ! به راحتی با خریداران دلخواه تماس بگیرید و با تبلیغ محصولات متعدد بیشترین خریداران را به خود جذب کنید. این بسته ۲۰٪ به صرفه تر از بسته سه ماه است.',
    'titles.specialPackageSecondDescription': 'باعث فروش محصولات شما در سریع ترین زمان ممکن می شود',
    ...
    'titles.weak': 'ضعیف',
    'titles.threeMonthBasicPackage': 'بسته پایه سه ماهه',
    'titles.annualSpecialPackage': 'بسته ویژه سالانه',
