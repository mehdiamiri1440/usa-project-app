export default {
  ...
  strings: {
    ...
    'labels.helperTextForInvitation': `همکارتان {firstName} {lastName}، شما را به جمع باسکول (بزرگترین بازار خرید و فروش عمده محصولات غذایی و کشاورزی) دعوت کرده است. اگر این دعوت را قبول می کنید روی لینک زیر بزنید.`,
