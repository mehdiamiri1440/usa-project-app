export default {
  ...
  strings: {
    ...
    'labels.contactInfoDescription': 'اطلاعات تماس شما در اختیار کاربران قرار گرفته است . شما می‌توانید دسترسی کاربران را به شماره تماس خود محدود کنید.',
    'labels.suggesstedProduct': 'محصول پیشنهادی',
    'labels.uploadProductImages': 'لطفا فقط تصاویر مرتبط با محصول خود را ثبت کنید.',
    'labels.terms': 'قوانین',
    'labels.limitAccess': 'دسترسی را محدود کن',
