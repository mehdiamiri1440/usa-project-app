module.exports = {
  ...
  strings: {
    ...
    'labels.specialPackageDescription': 'این بسته شامل مجموعه امکاناتی مانند اعمال نردبان رایگان ، مشاهده بدون تاخیر درخواست های خرید ، دریافت پیامک درخواست های خرید مرتبط و .. است که باعث فروش محصولات شما در رسیع ترین زمان ممکن می شود.',
