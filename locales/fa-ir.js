export default {
  ...
  strings: {
    ...
    'labels.zero': 'صفر',
    'labels.inviteFriendsText': 'با دعوت از همکاران خود به باسکول میتوانید کسب درآمد کنید. در صورتی که همکار دعوت شده به جمع باسکول بپیوندد بعد از خرید هر کدام از سرویس های غیر رایگان باسکول، نصف مبلغ خرید به کیف پول باسکول شما اضافه می شود.همین حالا دعوت نامه را ارسال کنید.',
