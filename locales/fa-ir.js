export default {
  ...
  strings: {
    ...
    'labels.hour': 'ساعت',
    'labels.responseToRequestExpired': 'فرصت پاسخ گویی شما به این درخواست به پایان رسیده است',
    ...
    'labels.remainedTimeToResponseToRequest': 'دیگر فرصت پاسخگویی شما به این درخواست',
    'labels.notifMeIfExists': 'در صورت داشتن این محصول به من پیام بده',
    ...
    'labels.messengerNoRelateRequstFoundFirst': 'در حال حاضر درخواست خریدی برای شما وجود ندارد',
    'labels.messengerNoRelateRequstFoundSecond': 'در صورت دریافت درخواست خرید، ما به شما اطلاع می دهیم',
