module.exports = {
  ...
  strings: {
    ...
    'labels.elevatorPackageDescription': 'با اعمال هربار نردبان محصول شما در صدر لیست محصولات قرار میگیرد.',
    'labels.passwordPackageDescription': 'درصورتی که قادر به خرید مستقیم نیستید ، برای پرداخت ازطریق کارت به کارت با ما تماس بگیرید.',
    "labels.one": 'یک',
